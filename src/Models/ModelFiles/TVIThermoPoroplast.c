...
#define NbOfVariables     (92)  //! always verify
static double Variable[NbOfVariables] ;
static double Variable_n[NbOfVariables] ; //ADDED
static double dVariable[NbOfVariables] ;  //ADDED
...
int pm(const char *s)
{
  ...
  else if(!strcmp(s,"thermal_hardening_parameter"))   return (54) ;// ADDED //! verify always with NbOfProp in ReadMatProp below
...
{
  int  NbOfProp = 55 ;                              //! verify always with above
  ...
  /* Elastic and plastic properties */
  {
...

    {
      ...
      /* ACC */
      {
        ...
        Plasticity_SetToACC(plasty) ;
        Plasticity_SetParameters(plasty,ACC_k,ACC_M,ACC_N,ACC_pt0,ACC_pc0,ACC_beta_eps,ACC_beta_T0) ;
